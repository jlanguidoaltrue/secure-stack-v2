...
import { EyeIcon, EyeOffIcon } from "../../constants/icons.js";
    ...
    <Paper className="p-6 max-w-md">
      ...
      <form onSubmit={submit}>
        <Stack spacing={2}>
              ...
              endAdornment: (
                <InputAdornment position="end">
                  <IconButton
                    ...
                    edge="end"
                    tabIndex={-1} // prevents losing focus on click
                  >
                    {showPassword ?   <EyeOffIcon style={{ fill: "#000000" }}/> : <EyeIcon style={{ fill: "#000000" }}/>}
                  </IconButton>
                </InputAdornment>
              ),
            }}
          ...
          <Typography color={msg.includes("failed") ? "error" : "success"}>
            {msg}
          </Typography>
          ...
          <div className="flex gap-2">
            ...
            <Button variant="outlined" onClick={() => oauth("microsoft")}>
              Microsoft
            </Button>
          </div>
        </Stack>
